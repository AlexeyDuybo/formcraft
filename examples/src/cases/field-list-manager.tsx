...
const fieldList1 = createControlledFieldList("field_1");
const fieldList2 = createControlledFieldList("field_2");
const fieldList3 = createControlledFieldList("filed_3");
...
sample({
  ...
  fn: ({ field1, field2, field3 }) => {
    const payload: Partial<{ field1: string; field2: string; field3: string }> =
      {};
    if (field1 !== "") {
