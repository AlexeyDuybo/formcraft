...
const field2 = createField("", { initialErrorState: true });
const field3 = createField("", { initialErrorState: false });
...
const group = groupFields(
  ...
  createStore(["field1", "nestedGroup"])
);
